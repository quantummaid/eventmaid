[![Maintainability Rating](https://sonarcloud.io/api/project_badges/measure?project=de.quantummaid.eventmaid%3Aeventmaid-parent&metric=sqale_rating)](https://sonarcloud.io/dashboard?id=de.quantummaid.eventmaid%3Aeventmaid-parent)
[![Reliability Rating](https://sonarcloud.io/api/project_badges/measure?project=de.quantummaid.eventmaid%3Aeventmaid-parent&metric=reliability_rating)](https://sonarcloud.io/dashboard?id=de.quantummaid.eventmaid%3Aeventmaid-parent)
[![Security Rating](https://sonarcloud.io/api/project_badges/measure?project=de.quantummaid.eventmaid%3Aeventmaid-parent&metric=security_rating)](https://sonarcloud.io/dashboard?id=de.quantummaid.eventmaid%3Aeventmaid-parent)
[![Quality Gate Status](https://sonarcloud.io/api/project_badges/measure?project=de.quantummaid.eventmaid%3Aeventmaid-parent&metric=alert_status)](https://sonarcloud.io/dashboard?id=de.quantummaid.eventmaid%3Aeventmaid-parent)
[![Bugs](https://sonarcloud.io/api/project_badges/measure?project=de.quantummaid.eventmaid%3Aeventmaid-parent&metric=bugs)](https://sonarcloud.io/dashboard?id=de.quantummaid.eventmaid%3Aeventmaid-parent)
[![Code Smells](https://sonarcloud.io/api/project_badges/measure?project=de.quantummaid.eventmaid%3Aeventmaid-parent&metric=code_smells)](https://sonarcloud.io/dashboard?id=de.quantummaid.eventmaid%3Aeventmaid-parent)
[![Technical Debt](https://sonarcloud.io/api/project_badges/measure?project=de.quantummaid.eventmaid%3Aeventmaid-parent&metric=sqale_index)](https://sonarcloud.io/dashboard?id=de.quantummaid.eventmaid%3Aeventmaid-parent)
[![Coverage](https://sonarcloud.io/api/project_badges/measure?project=de.quantummaid.eventmaid%3Aeventmaid-parent&metric=coverage)](https://sonarcloud.io/dashboard?id=de.quantummaid.eventmaid%3Aeventmaid-parent)
