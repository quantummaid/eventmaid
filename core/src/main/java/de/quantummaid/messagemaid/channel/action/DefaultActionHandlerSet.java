...
import static de.quantummaid.messagemaid.channel.action.ActionHandlerSet.emptyActionHandlerSet;
import static de.quantummaid.messagemaid.channel.action.CallActionHandler.callActionHandler;
import static de.quantummaid.messagemaid.channel.action.ConsumerActionHandler.consumerActionHandler;
import static de.quantummaid.messagemaid.channel.action.ReturnActionHandler.returnActionHandler;
import static de.quantummaid.messagemaid.channel.action.SubscriptionActionHandler.subscriptionActionHandler;
